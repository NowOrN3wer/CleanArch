...
To install, you can visit [NuGet (https://www.nuget.org/packages/TS.CleanArch)](https://www.nuget.org/packages/TS.CleanArch/)

Or you can install it by running the following code block:

```powershell
dotnet new install TS.CleanArch
```

After the installation is complete, you can view the VS2022 project list with `dotnet new list` and search for the project template "ASP.NET Clean Architecture Solution" with the short name "ts.cleanarch". If you find it in the list, you can now create a new project via VS2022 and find it by searching for "Clean Architecture" in the project search bar.

![Proje Template](https://github.com/TanerSaydam/CleanArch.Template/blob/main/images/projeyibulma.png)

After selecting the project, give it any name you want, for example `eCommerce`

![Proje Structure](https://github.com/TanerSaydam/CleanArch.Template/blob/main/images/projestructure.png)
...
![Connection String](https://github.com/TanerSaydam/CleanArch.Template/blob/main/images/connectionstring.png)
...
![Create First User](https://github.com/TanerSaydam/CleanArch.Template/blob/main/images/createfirstuser.png)